...
> Example Format:
> `"Main Auditorium" located on Floor 1 of Arts Faculty Building`
...
###  viii. Verify Room Availability

1. Return to the **Room Booking dashboard**.
2. Search for the new room: `Main Auditorium`.
3. Attempt to book it (e.g., **8 Sep 2025**, **9:00 AM – 5:00 PM**).
4. If **Restricted**, ensure only Dr. Silva (or other ACL users) can book.
